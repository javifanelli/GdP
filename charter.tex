...
1.1		& Se completa hasta la sección 5 inclusive							& 24/10/2022 \\ \hline
%1.2		& Se completa hasta la sección 9 inclusive							& 31/10/2022 \\ \hline
%1.3		& Se completa hasta la sección 12 inclusive							& dd/mm/aaaa \\ \hline
%1.4		& Se completa hasta la sección 15 inclusive (Se completa el plan)		& dd/mm/aaaa \\ \hline
...
Por medio de la presente se acuerda con el Ing. \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'', consistirá esencialmente en el diseño e implementación de un prototipo un sistema de control de ambientes por internet, y tendrá un presupuesto preliminar estimado de 600 hs de trabajo (a definir detalladamente más adelante) y monto a definir, con fecha de inicio \fechaInicioName\hspace{1px} y fecha de presentación pública \fechaFinalName.
...
En la figura 1 se muestra un diagrama en bloques del sistema a desarrollar en el proyecto. Se observa que consta de 2 partes físicas diferenciables: el nodo, o actuador remoto, y el servidor backend, implementado en una Raspberry Pi. El nodo a su vez estará compuesto por el módulo de control (comandado por una placa de desarrollo con ESP32), un display para indicar los valores medidos y seteados, un potenciómetro digital para variar la temperatura, una salida de relé para el calefactor y una salida PWM para controlar una luminaria LED de 12VCC. El usuario podrá acceder mediante una página web, con usuario y contraseña, a visualizar y cambiar los parámetros de la habitación donde esté instalado el sistema. El sistema se probará con un sólo nodo.

La diferencia con los sistemas ya existentes, es que sea fácilmente adaptable a entornos fuera de un hogar y una oficina, tales como una sala de servidores, un área limpia de un laboratorio, u otros lugares donde se requiera sensar distintos parámetros y poder tener un historial de ellos.
...
\begin{itemize}
	...
	\item Responsable: Ing. Javier Fanelli, único responsable a cargo del desarrollo del proyecto. Se ocupará de la planificación y ejecución de las tareas.
...
\begin{itemize}
	\item Desarrollo y fabricación de un prototipo de nodo de control que sense temperatura y actúe una salida ON-OFF para controlar el calefactor y el control de la iluminación.
	\item Desarrollo de los prototipos de circuitos complementarios al nodo.
...
\begin{itemize}
	...
	\item Se contará con los recursos económicos y el tiempo para desarrollarlo con normalidad.
\end{itemize}
