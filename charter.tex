...
Es sabido por muchos que la domótica, el monitoreo y el control de parámetros dentro de un ambiente está creciendo a grandes pasos. Tanto es así que empresas grandes como Google, Apple o Amazon están desarrollando sus propios sistemas completos de domótica. Inclusive, están desarrollando un sistema que sea compatible entre esas marcas y muchas otras, llamado Matter, de código abierto.

Lo anterior muestra el interés y hasta a veces la necesidad de conocer el estado y poder manejar parámetros a distancia de habitaciones, oficinas, salas de estar, y otras salas. De esta manera, se facilita la vida cotidiana y se pueden generar situaciones de confort con poco esfuerzo, dedicando el tiempo y la energía en otros aspectos de la vida cotidiana. Tan sólo con un click o pulsar una pantalla, se conocen o modifican los estados del sector que se desee.
...
En la figura 1 se muestra un diagrama en bloques del sistema a desarrollar en el proyecto. 
