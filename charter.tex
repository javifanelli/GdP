...
0      & Creación del documento                                 & 20/10/2022 \\ \hline
1      & Se completaron nombres y título del proyecto            & 24/10/2022 \\ \hline
2      & Se completó hasta el punto 5 inclusive					& 31/10/2022 \\ \hline
...
Por medio de la presente se acuerda con el Ing. \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'', consistirá esencialmente en el diseño e implementación de un prototipo un sistema de control de ambientes por internet, y tendrá un presupuesto preliminar estimado de 600 hs de trabajo y \$XXX, con fecha de inicio \fechaInicioName\hspace{1px} y fecha de presentación pública \fechaFinalName.
